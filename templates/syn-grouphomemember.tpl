...
{if $mgrpname|in_group}
	<div class="mar-bottom-xl">
		<a href="syn_organicgrp_managegrp?itemId={$smarty.get.organicgroup}&organicgroup={$smarty.get.organicgroup}" class="btn btn-default button-bar pull-left"> {tr _0=$prefs.ta_syn_organicgrp_sterm}Manage %0 Members{/tr}</a>
