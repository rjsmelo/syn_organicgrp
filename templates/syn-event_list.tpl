	...
	<div class="media">
		...
		<div class="media-body">
			<h5 class="media-heading">
				<a href="./syn_organicgrp_ViewEvent?itemId={$result.object_id|escape}&organicgroup={$result.tracker_field_groupId}&cat={$result.categories[0]}" class="title">{$result.title|escape}</a>
			</h5>
			{$result.event_desc}
